...
import com.example.vaccineapp.databinding.FragmentScheduledVaccinationsBinding
...
class ScheduledVaccinationsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentScheduledVaccinationsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            viewModel.getScheduledVaccinations()
            ...
            binding.scheduledVaccinationsRV.adapter = adapter
        }
        val layoutManager = LinearLayoutManager(context)
        binding.scheduledVaccinationsRV.layoutManager = layoutManager
    }
